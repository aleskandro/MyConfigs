                ...
                while True:
                        ...
                        while True:
                                ...
                                if result:
                                        ...
                                        str = ""
                                        if len(result) > 0:
                                            str = '\n{0} new unread messages'.format(len(result))
                                        ...
                                        for each in result:
                                                ...
                                                try:
                                                        ...
                                                        str += "\nFrom: {0}".format(re.search(r'<(.*)>', mail['from']).group(1))
                                                        str += "\n Subject: {0}".format(mail['subject'])
                                                except Exception:
                                                        log.error(
                                                        ...
                                                        continue
                                        if len(result) > 0:
                                            os.system("notify-send '{0}' '{1}'".format(username, str))
                                else:
                                        imap.idle_done()
                                        imap.noop()
